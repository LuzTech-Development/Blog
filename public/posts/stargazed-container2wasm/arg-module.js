Module['arguments'] = [
  ...
  '/pack/bzImage',
  '-append',
  'earlyprintk=ttyS0,115200n8 console=ttyS0,115200n8 slub_debug=F root=/dev/vda rootwait acpi=off ro virtio_net.napi_tx=false loglevel=0 QEMU_MODE=1 init=/sbin/tini -- /sbin/init',
  '-virtfs',
