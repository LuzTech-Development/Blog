...
(() => {
  ...
  loadPackage({
    files: [
      { filename: '/pack/bios-256k.bin', start: 0, end: 262144 },
      { filename: '/pack/bzImage', start: 262144, end: 3613056 },
      { filename: '/pack/efi-virtio.rom', start: 3613056, end: 3773824 },
      { filename: '/pack/kvmvapic.bin', start: 3773824, end: 3783040 },
      { filename: '/pack/linuxboot_dma.bin', start: 3783040, end: 3784576 },
      { filename: '/pack/rootfs.bin', start: 3784576, end: 95258496 },
      { filename: '/pack/vgabios-stdvga.bin', start: 95258496, end: 95297920 },
      { filename: '/pack/vm.state', start: 95297920, end: 137481597 }
    ],
    remote_package_size: 137481597
  });
})();
