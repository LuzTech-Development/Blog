...
(() => {
  ...
  loadPackage({
    files: [
      ...
      { filename: '/pack/rootfs.bin', start: 3784576, end: 63629184 },
      { filename: '/pack/vgabios-stdvga.bin', start: 63629184, end: 63668608 },
      { filename: '/pack/vm.state', start: 63668608, end: 105868800 }
    ],
    remote_package_size: 105868800
  });
})();
